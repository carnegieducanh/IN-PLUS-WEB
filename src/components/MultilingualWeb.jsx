          ...
          <div className="relative order-2 flex w-full items-center justify-center lg:order-1 lg:w-1/2">
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative z-10">
                <img
                  src="https://www.in-plus.co.jp/wp-content/uploads/mutilang-1-min.png"
              ...
              <div className="absolute right-2 bottom-4 z-20 md:right-4 md:bottom-6">
                <img
                  src="https://www.in-plus.co.jp/wp-content/uploads/inplus-t002-min.png"
                  alt="SIM Card Usage"
...
export default MultilingualWeb;
